...
Ahora supongamos que nos interesa predecir el tiempo de reacción de un paciente cualquiera en los días 1, 5 y 9, y los intervalos de confianza del 95% para la predicción en esos mismos días. Para eso vamos a usar la función `predict_response()` de la siguiente manera:

```{r}
# conditional predictions
predict_response(fit, "Days [1,5,9]")
```
