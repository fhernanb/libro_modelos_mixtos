...
Según el resultado anterior $\hat{\boldsymbol{\Theta}}=(\hat{\beta}_0=3.533631, \hat{\beta}_1=-5.978053, \hat{\sigma}_y=4.01157, \hat{\sigma}_{b0}=21.50711)^\top$ mientras que el vector real de parámetros es $\boldsymbol{\Theta}=(\beta_0=4, \beta_1=-6, \sigma_y=4, \sigma_{b0}=25)^\top$.
