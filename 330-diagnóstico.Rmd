...
```{r, echo = FALSE, eval = FALSE, message = FALSE, warning = FALSE, fig.showtext = TRUE, out.width = "100%", fig.align = "center", fig.cap = "Representación gráfica de los residuos, del valor estimado y del valor observado."}
...
```{r, echo = FALSE, eval = FALSE, message = FALSE, fig.align = "center", fig.cap = "Representación visual de la gráfica de residuos contra los valores estimados."}
...
```{r echo=FALSE, out.width="100%", fig.align='center', fig.cap = "Representación visual de la gráfica de residuos contra los valores estimados."}
knitr::include_graphics("images/dibujo_residuos_supuestos.png")
```
...
```{r, echo = FALSE, eval = FALSE, message = FALSE, warning = FALSE, fig.showtext = TRUE, out.width = "100%", fig.align = "center", fig.cap = "Ejemplo de distribución normal de los residuos y de aquellos residuos que no cumplen con este supuesto."}
...
```{r echo=FALSE, out.width="100%", fig.align='center', fig.cap = "Ejemplo de distribución normal de los residuos y de aquellos residuos que no cumplen con este supuesto."}
knitr::include_graphics("images/distribucion_residuos.png")
```
...
```{r, eval = FALSE, echo = FALSE, fig.align = "center", fig.cap = "Diagrama de árbol para elegir el tipo de distribución de los datos, adaptado de Aswath Damodaran.", message = FALSE, warning = FALSE, fig.showtext = TRUE}
...
```{r echo=FALSE, out.width="100%", fig.align='center', fig.cap = "Diagrama de árbol para elegir el tipo de distribución de los datos, adaptado de Aswath Damodaran."}
knitr::include_graphics("images/arbol_elegir_dist.png")
```
