...
La gráfica a continuación presenta los valores observados y estimados en el rendimiento de los alumnos en una prueba de matemáticas según su nivel socio-económico, siendo la misma una representación gráfica similar a la presentada en la **Figura 6.1**:
...
```{r Grafica de residuos, echo = FALSE, eval = TRUE, message = FALSE, fig.align = "center", out.width = "80%"}
