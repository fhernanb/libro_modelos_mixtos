...
En este capítulo se presenta un ejemplo de glmm con variable respuesta Poisson.
...
De la figura anterior vemos que el comportamiento de la variable respuesta es muy diferente dada la escuela
...
\begin{align*} 
y_{ij} &\sim  Poisson(\mu_{ij}) \\ 
\log(\mu_{ij}) &= \beta_0 + \beta_1 female_i + b_{0i} \\
b_0 &\sim N(0, \sigma_{b0}^2)
\end{align*}
