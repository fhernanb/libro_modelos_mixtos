...
y_{ij} | b_0 &\sim  N(\mu_{ij}, \sigma^2_y) \\ 
\mu_{ij} &= 4 - 6 x_{ij} + b_{0i} \\
\text{Hombre} \quad \sigma^2_y &= 9 \times 1 \\
\text{Mujer} \quad \sigma^2_y &= 9 \times 6 \\
b_{0} &\sim N(0, \sigma^2_{b0}=64) \\
x_{ij} &\sim U(0, 200)
\end{align*}
...
De la figura anterior vemos claramente los residuales no se comportan igual para hombres y mujeres, esto es un indicio de que se debe modelar la varianza $\sigma^2_y$ teniendo en cuenta el sexo.
