...
En el capítulo \@ref(reg-lin) se hace un repaso básico del modelo de regresión lineal clásico. En el capítulo \@ref(lmm) se presentan el modelo lineal mixto (LMM) y luego en el capítulo \@ref(glmm) se presentan los modelos lineales generalizados mixtos (GLMM). En el capítulo \@ref(pac-lme4) se presenta el paquete **lme4** y sus principales funciones para modelación, mientras que en el capítulo \@ref(pac-nlme) se presenta el paquete **nlme** y sus principales funciones para modelación. En el capítulo \@ref(R2) se muestra la forma de calcular la medida $R^2$ para LMM y GLMM.
